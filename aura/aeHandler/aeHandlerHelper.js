        ...
        action.setCallback(this, function(response) {
            ...
            if (component.isValid() && state === "SUCCESS") {
                ...
                for(var i = 0 ; i < travelTypeArrLen ; i++){
                    if(travelReqFormWrap.travReqObj.Travel_Type__c === travelReqFormWrap.lstTravelTypeOpts[i]){
                ...
                for(var i = 0 ; i < travelByArrLen ; i++){
                    if(travelReqFormWrap.travReqObj.Travel_By__c === travelReqFormWrap.lstTravelByOpts[i]){
				...
				console.log('>>>>>>>>>>>>>>>>>>> Source Name : ' + travelReqFormWrap.travReqObj.Source__r.Name);
                for(var i = 0 ; i < sourceArrLen ; i++){
                    console.log('>>>>>>>>>>>>>>>>>>> Source Name : ' + i + travelReqFormWrap.lstSourceOpts[i]);
                    if(travelReqFormWrap.travReqObj.Source__r.Name === travelReqFormWrap.lstSourceOpts[i]){
						//debugger;
                ...
                for(var i = 0 ; i < destinationArrLen ; i++){
                    console.log('>>>>>>>>>>>>>>>>>>>>>>> desti' + travelReqFormWrap.travReqObj.Destination__c );
                    if(travelReqFormWrap.travReqObj.Destination__r.Name === travelReqFormWrap.lstDestinationOpts[i]){
